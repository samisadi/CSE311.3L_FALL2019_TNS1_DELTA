...
while ($result = mysqli_fetch_assoc($data)) {
   ...
   echo "
	...
	<tr>
		...
		<td><a href='ordermanage.php?sid=$result[sid] &id=$result[id] &product_name=$result[product_name] &product_price=$result[product_price]&user_name=$result[user_name]&address=$result[address]'>REMARK</a></td>
