...
<?php
 ...
 if (isset ($_POST ['register'])){
	 ...
	 if ($first_name !=""and $middle_name !="" and $last_name !="" and $user_name !="" and $password !=""){
	 
	 $q= "INSERT INTO `user`(`id`, `first_name`, `middle_name`, `last_name`, `user_name`, `password`)
	 VALUES('', '".$first_name."','".$middle_name."','".$last_name."','".$user_name."','".$password."')
	 ";
